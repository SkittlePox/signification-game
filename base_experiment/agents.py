...
from ablated_agents import ActorCriticListenerConvAblationReady, LISTENER_ARCH_ABLATION_PARAMETERS, ActorCriticListenerConvSkipPoolReady, LISTENER_ARCH_SKIPPOOL_PARAMETERS, ActorCriticSpeakerSplinesAblationReady, SPEAKER_ARCH_ABLATION_PARAMETERS, ActorCriticListenerDenseAblationReady, LISTENER_ARCH_DENSE_PARAMETERS
from quantized_agents import ActorCriticListenerConvAblationQuantizeReady, LISTENER_ARCH_ABLATION_QUANTIZATION_PARAMETERS, ActorCriticSpeakerDenseQuantized, SPEAKER_ARCH_QUANTIZATION_PARAMETERS, ActorCriticSpeakerDensePerSplineQuantized, SPEAKER_ARCH_PERSPLINE_QUANTIZATION_PARAMETERS, ActorCriticSpeakerRNNQuantized, SPEAKER_ARCH_RNN_QUANTIZATION_PARAMETERS
