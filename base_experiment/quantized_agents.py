...
SPEAKER_ARCH_RNN_QUANTIZATION_PARAMETERS = {
    ...
    "splines-rnn-quantized-A0PE-0": {     # Base is micro-A-3, with positional *embeddings*
        "SPEAKER_ARCH_RNN_QUANTIZATION_PARAMETERS": {
            "embedding_latent_dim": 32,
            "embedding_dims": [32, 16, 4],
            "critic_dims": [16, 16],
            "rnn_hidden_dim": 8,
            "use_vq": False,
            "use_pos_embs": True,
    ...
    "splines-rnn-quantized-A0PE-1b": {     # Base is micro-A-3, with positional *embeddings*
        "SPEAKER_ARCH_RNN_QUANTIZATION_PARAMETERS": {
            "embedding_latent_dim": 32,
            "embedding_dims": [32, 16, 12],
            "critic_dims": [16, 16],
            "rnn_hidden_dim": 24,
            "use_vq": False,
            "use_pos_embs": True,
            "pos_emb_latent_dim": 12
        }
    },
    ...
    "splines-rnn-quantized-A0PE-2b": {     # Base is micro-A-3, with positional *embeddings*
        "SPEAKER_ARCH_RNN_QUANTIZATION_PARAMETERS": {
            "embedding_latent_dim": 32,
            "embedding_dims": [32, 16, 24],
            "critic_dims": [16, 16],
            "rnn_hidden_dim": 48,
            "use_vq": False,
            "use_pos_embs": True,
    ...
    "splines-rnn-quantized-A0PE-5": {     # Base is micro-A-3, with positional *embeddings*
        "SPEAKER_ARCH_RNN_QUANTIZATION_PARAMETERS": {
            "embedding_latent_dim": 32,
            "embedding_dims": [32, 32, 128],
            "critic_dims": [16, 16],
            ...
            "use_vq": False,
            "use_pos_embs": True,
            "pos_emb_latent_dim": 128
        }
    },
    "splines-rnn-quantized-A0PE-6": {     # Base is micro-A-3, with positional *embeddings*
        "SPEAKER_ARCH_RNN_QUANTIZATION_PARAMETERS": {
            "embedding_latent_dim": 32,
            "embedding_dims": [32, 32, 256],
            "critic_dims": [16, 16],
