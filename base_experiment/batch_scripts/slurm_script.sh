...
python3 -u ippo_ff.py WANDB_NOTES="Post-Hiatus-R4 - Whitesum Penalty" ENV_KWARGS.channel_ratio_fn="sigmoid-custom" ENV_KWARGS.sigmoid_offset=800 ENV_KWARGS.sigmoid_stretch=0.003 SPEAKER_TRAIN_SCHEDULE="off then on at 324" LISTENER_LR_SCHEDULE="1e-4 jump to 2e-6 at 324" SPEAKER_LR_SCHEDULE="2e-4"
