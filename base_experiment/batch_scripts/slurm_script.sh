...
python3 -u ippo_ff.py WANDB_NOTES="Post-Hiatus-R1 - quadrortx - Trying 5 agents and looking for results with new iconicity probe" ENV_KWARGS.channel_ratio_fn="sigmoid-custom" ENV_KWARGS.sigmoid_offset=600 ENV_KWARGS.sigmoid_stretch=0.005 SPEAKER_TRAIN_SCHEDULE="off then on at 324" LISTENER_LR_SCHEDULE="1e-4 jump to 1e-6 at 324 anneal to 2e-5 at 1500"
