...
python3 -u ippo_ff.py WANDB_NOTES="Post-Draft-R4e - Log test Basic Experiment - No penalties - 6 referents" ENV_KWARGS.channel_ratio_fn="0.4 at 300" ENV_KWARGS.speaker_referent_span_fn=6 ENV_KWARGS.speaker_whitesum_penalty_coef=0.0 SPEAKER_TRAIN_SCHEDULE="off then on at 300" LISTENER_LR_SCHEDULE="1e-4 jump to 1e-6 at 300 anneal to 2e-5 at 1500" SPEAKER_LR_SCHEDULE=2e-4 L2_REG_COEF_LISTENER=1e-5 L2_REG_COEF_SPEAKER=1e-5 UPDATE_EPOCHS=100 PICKLE_FINAL_AGENTS=True WANDB_MODE="online"
